  ...
  return (
    ...
    >
      {!isDark && (
        <>
          <div
            className="absolute -top-24 -right-24 w-[40rem] h-[40rem] rounded-full bg-brand-yellow/15 blur-[140px] pointer-events-none"
            aria-hidden="true"
          />
          <div
            className="absolute -bottom-20 -left-20 w-[35rem] h-[35rem] rounded-full bg-brand-navy/10 blur-[120px] pointer-events-none"
            aria-hidden="true"
          />
        </>
      )}
