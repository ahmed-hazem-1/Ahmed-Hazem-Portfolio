  ...
  return (
    ...
    >
      {!isDark && (
        <>
          <div
            className="fluid-blob light-blob-yellow-1 absolute -top-[15%] -left-[15%] pointer-events-none z-0"
            aria-hidden="true"
          />
          <div
            className="fluid-blob light-blob-navy-2 absolute -bottom-[15%] -right-[15%] pointer-events-none z-0"
            aria-hidden="true"
          />
        </>
      )}
